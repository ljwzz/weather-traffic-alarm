...
- **彩云天气已接入**：Android 已实现候选凭证连接测试、双地点小时天气评估、15 分钟故障缓存和手动天气预览；设备实网与界面验证结果见 [2026-09-02 验证记录](./android/qa/caiyun-device-2026-09-02.md)。天气 Provider 不会创建、取消或修改本地闹钟。v2.6 鉴权契约见 https://docs.caiyunapp.com/weather-api/v2/v2.6/auth.html 。
